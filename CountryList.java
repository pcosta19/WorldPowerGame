...
public class CountryList {
	...
	static List<Country> allCountries = new ArrayList<Country>();
	public CountryList()
	{
		allCountries.addAll(Arrays.asList(
				new Country("afghanistan", 20.82, 0, 0.001433, 0.498),
				new State("alabama",0,0,0,0,0),
				new State("alaska", 0, 0, 0, 0, 0),
				...
				new State("arizona", 0, 0, 0, 0, 0),
				new State("arkansas", 0, 0, 0, 0, 0),
				...
				new State("california", 0, 0, 0, 0, 0),
				...
				new State("colorado", 0, 0, 0, 0, 0),
				new Country("comoros", 0.6489, 0, 0.000024, 0.503),
				new State("connecticut", 0, 0, 0, 0, 0),
				...
				new State("district of columbia", 0, 0, 0, 0, 0),
				...
				new State("georgia state", 0, 0, 0, 0, 0),
				...
				new State("idaho", 0, 0, 0, 0, 0),
				new State("illinois", 0, 0, 0, 0, 0),
				new Country("india", 2597, 135, 0.073444, 0.640),
				new State("indiana", 0, 0, 0, 0, 0),
				new Country("indonesia", 1016, 0, 0.013708, 0.694),
				new State("iowa", 0, 0, 0, 0, 0),
				...
				new State("kansas", 0, 0, 0, 0, 0),
				new Country("kazakhstan", 159.4, 0, 0.003233, 0.800),
				new State("kentucky", 0, 0, 0, 0, 0),
				...
				new State("maryland", 0, 0, 0, 0, 0),
				new State("massachusetts", 0, 0, 0, 0, 0),
				...
				new State("michigan", 0, 0, 0, 0, 0),
				new Country("micronesia", 0.3664, 0, 0.000003, 0.627),
				new State("minnesota", 0, 0, 0, 0, 0),
				new State("mississippi", 0, 0, 0, 0, 0),
				new State("missouri", 0, 0, 0, 0, 0),
				...
				new State("nebraska", 0, 0, 0, 0, 0),
				new Country("nepal", 24.47, 0, 0.001437, 0.574),
				new Country("netherlands", 826.2, 0, 0.005646, 0.931),
				new State("nevada", 0, 0, 0, 0, 0),
				new State("new hampshire", 0, 0, 0, 0, 0),
				new State("new jersey", 0, 0, 0, 0, 0),
				new State("new mexico", 0, 0, 0, 0, 0),
				new State("new york", 0, 0, 0, 0, 0),
				...
				new State("north carolina", 0, 0, 0, 0, 0),
				new State("north dakota", 0, 0, 0, 0, 0),
				new Country("norway", 398.8, 0, 0.001640, 0.953),
				new State("ohio", 0, 0, 0, 0, 0),
				new State("oklahoma", 0, 0, 0, 0, 0),
				new Country("oman", 72.64, 0, 0.001217, 0.821),
				new State("oregon", 0, 0, 0, 0, 0),
				...
				new State("pennsylvania", 0, 0, 0, 0, 0),
				...
				new State("rhode island", 0, 0, 0, 0, 0),
				...
				new Country("samoa", 0.8566, 0, 0.000005, 0.713),
				...
				new State("south carolina", 0, 0, 0, 0, 0),
				new State("south dakota", 0, 0, 0, 0, 0),
				...
				new State("tennessee", 0, 0, 0, 0, 0),
				new State("texas", 0, 0, 0, 0, 0),
				...
				new State("vermont", 0, 0, 0, 0, 0),
				new Country("vietnam", 223.9, 0, 0.007113, 0.694),
				new State("virginia", 0, 0, 0, 0, 0),
				new State("washington", 0, 0, 0, 0, 0),
				new State("west virginia", 0, 0, 0, 0, 0),
				new State("wisconsin", 0, 0, 0, 0, 0),
				new State("wyoming", 0, 0, 0, 0, 0),
